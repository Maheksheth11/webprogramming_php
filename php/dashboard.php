    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/maheksheth/home" target="_blank">Google Site</a></li>
                    ...
                    <li class="list-group-item"><a href="https://github.com/Maheksheth11/webprogramming_php" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                ...
                <div class="container">
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
						<a href="https://github.com/Maheksheth11/webprogramming_php/tree/main/task1">
